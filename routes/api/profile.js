...
router.get("/handle/:handle", (req, res) => {
  const errors = {};
  console.log("Getting profile for handle: " + req.params.handle);
  profile
...
router.post(
  ...
  (req, res) => {
    ...
    if (typeof req.body.skills !== "undefined") {
      profileFields.skills = req.body.skills.split(","); //split skills as they come in comma separated
    }
